...
def request(curr_user):
   ...
   Label(root12,text="Parking Request",bg="yellow",fg="black",font=("Courier", 24)).place(x=390,y=250)
   ...
   Label(root12,text="select vehicles:",bg="olivedrab2",fg="black").place(x=300,y=460)
   vehicles=OptionMenu(root12,drop1,"2","4").place(x=400,y=460)
   Fare=Label(root12,bg="olivedrab2",fg="black",textvariable=fare).place(x=370,y=500)
   f=Label(root12,text="Fare(in Rs):",bg="olivedrab2",fg="black").place(x=300,y=500)
   ...
   FareCal=Button(root12,text="Calculate Fare",bg="red",command=calculate_fare).place(x=410,y=540)
   # booking slot button for parking
   park=Button(root12,text="Reserve Parking Slot",bg="red",command=reserve).place(x=380,y=570)
   root12.mainloop()
